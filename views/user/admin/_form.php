...
<div class="user-form">
    ...
    <div class="form-group">
        <?= Html::submitButton($user->isNewRecord ? Yii::t('user', 'Criar') : Yii::t('user', 'Atualizar'), ['class' => 'btn btn-primary rounded-pill w-100 mt-4', 'style'=>'background-color:#816; color:#white; border: #816 solid 1px;', 'onmouseenter'=>'alterColorEnter(this)', 'onmouseout'=>'alterColorOut(this)']) ?>
    </div>
